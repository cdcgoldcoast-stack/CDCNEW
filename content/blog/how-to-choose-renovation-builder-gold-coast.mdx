...
I'll be upfront -- I'm a QBCC-licensed builder with over 25 years on the Gold Coast, so I have a perspective here. But I've also seen what happens when homeowners choose the wrong builder, and I'd rather you know what to look for, even if you don't end up choosing us. A good builder will welcome every question on this list.
...
**1. They want a large upfront deposit.** Under Queensland law, deposit limits depend on the contract value: for contracts **under $20,000**, a builder cannot ask for more than **10% of the contract price as a deposit**; for contracts **$20,000 and over**, the maximum deposit is **5% of the contract price**. If someone asks for 30% or 50% upfront, walk away. It's both illegal and a sign of cash-flow problems.
...
*Source: [QBCC — Contracts and payments](https://www.qbcc.qld.gov.au/home-owner-hub/build-renovate/contracts-payments)*
...
*Source: [QBCC — Queensland Home Warranty Scheme](https://www.qbcc.qld.gov.au/news/understanding-queensland-home-warranty-scheme-guide-property-owners)*

After the build, under the QBCC your builder must provide **6 years and 6 months** warranty for structural defects, and **6 months** for non-structural defects (cosmetic items, fixtures, fittings). Get the warranty in writing and keep your contract and all correspondence. If a defect appears within these periods and the builder refuses to rectify it, you can lodge a complaint with the QBCC — which is another reason working with a licensed builder matters.

*Source: [QBCC — Time limits for cover and claims](https://www.qbcc.qld.gov.au/your-property/queensland-home-warranty-scheme/time-limits-cover-claims)*
...
- [ ] Deposit request within legal limits (5% for contracts $20,000+, 10% for contracts under $20,000)
