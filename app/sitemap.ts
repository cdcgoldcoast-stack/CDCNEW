...
const staticRoutes: Array<{
  ...
  // Service + Suburb crossover pages
  { path: "/kitchen-renovations-broadbeach", changeFrequency: "weekly", priority: 0.7 },
  { path: "/bathroom-renovations-broadbeach", changeFrequency: "weekly", priority: 0.7 },
  { path: "/kitchen-renovations-surfers-paradise", changeFrequency: "weekly", priority: 0.7 },
  { path: "/bathroom-renovations-surfers-paradise", changeFrequency: "weekly", priority: 0.7 },
  { path: "/kitchen-renovations-robina", changeFrequency: "weekly", priority: 0.7 },
  { path: "/bathroom-renovations-robina", changeFrequency: "weekly", priority: 0.7 },
  { path: "/kitchen-renovations-southport", changeFrequency: "weekly", priority: 0.7 },
  { path: "/bathroom-renovations-southport", changeFrequency: "weekly", priority: 0.7 },
  { path: "/kitchen-renovations-helensvale", changeFrequency: "weekly", priority: 0.7 },
  { path: "/bathroom-renovations-helensvale", changeFrequency: "weekly", priority: 0.7 },
  { path: "/kitchen-renovations-palm-beach", changeFrequency: "weekly", priority: 0.7 },
  { path: "/bathroom-renovations-palm-beach", changeFrequency: "weekly", priority: 0.7 },
