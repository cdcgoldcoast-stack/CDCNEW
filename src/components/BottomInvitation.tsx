  ...
  return (
    <section className={cn("mt-12 md:mt-20 mb-8 md:mb-12 bg-primary", className)}>
      <div className="py-10 md:py-24 px-5 md:px-8 text-center">
        ...
        <Link
          to={ctaTo}
          className="bg-primary-foreground text-primary px-8 py-3 text-sm uppercase tracking-widest hover:bg-primary-foreground/90 transition-colors inline-block"
        >
          {ctaLabel}
        </Link>
      </div>
