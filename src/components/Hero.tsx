        ...
        <div className={`flex-1 flex items-center md:order-1 ${revealed}`}>
          <div className="max-w-xl px-5 py-8 md:px-0 md:py-0">
            ...
            <a
              ...
              className="bg-primary text-primary-foreground px-6 md:px-8 py-3 text-xs uppercase tracking-widest hover:opacity-90 transition-opacity inline-block mt-6 md:mt-8"
            >
