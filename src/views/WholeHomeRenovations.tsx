...
const wholeHomeImages = {
  ...
  extension: "https://iqugsxeejieneyksfbza.supabase.co/storage/v1/object/public/gallery-images/hallway-renovation-southport-gold-coast-concept-design-construct.webp",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24 bg-cream relative z-10">
        <div className="container-wide">
          <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Services", href: "/renovation-services" }, { label: "Whole-Home Renovations" }]} />
      ...
      <section className="py-16 md:py-24 bg-cream relative z-10">
        <div className="container-wide">
          ...
          <p className="text-foreground/70 text-center mb-10 max-w-2xl mx-auto">
            We deliver whole-home renovations throughout the Gold Coast. Find your local area below.
          </p>
