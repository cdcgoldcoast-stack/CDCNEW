...
const WHATSAPP_URL =
  "https://wa.me/61413468928?text=Hi%2C%20I%27m%20interested%20in%20a%20Gold%20Coast%20renovation.";
...
export default function GoldCoastRenovations() {
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <main id="main-content">
      <SEO
        title="Gold Coast Renovations | Free Consultation | CD Construct"
        description="Transform your Gold Coast home with QBCC licensed renovations. Kitchen, bathroom & whole-home experts since 2000. Book your free consultation today."
        url="/gold-coast-renovations"
      />
          ...
          <div className="grid lg:grid-cols-[1fr_440px] gap-12 lg:gap-16 items-start">
            <div>
              ...
              <div className="flex flex-col gap-3 mb-8">
                ...
                >
                  Can't talk? <span className="underline">Get a fast callback →</span>
                </a>
              </div>
              ...
              <blockquote className="mt-8 border-l-2 border-primary/30 pl-6 font-serif italic text-foreground/75">
                “Throughout the process they have been professional, communicative and supportive.
                We couldn't have asked for a better team for our first experience with renovating.”
            ...
            <div id="quote-form" className="bg-background border border-border/60 p-6 md:p-8 lg:sticky lg:top-28">
              <QuoteFormInline
                source="gold-coast-hero"
        ...
        <div className="container-wide">
          ...
          <div className="mt-10 border-l-2 border-primary/30 pl-6">
            ...
            <p className="text-sm text-foreground/50 mt-3">
              Gold Coast Renovation Specialists Since 2000 · QBCC Licensed · Master Builders · 4.9★ Google (50+ Reviews)
            </p>
          </div>
        </div>
      </section>
              ...
              <div key={service.title} className="bg-background overflow-hidden">
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <Link to={service.href} className="text-label text-primary hover:underline">
                      Learn more →
                    </Link>
