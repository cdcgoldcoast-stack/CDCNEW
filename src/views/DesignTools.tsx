...
const DesignTools = () => {
  const tools = [
    ...
    },
    {
      ...
      href: "/renovation-design-tools/moodboard",
      comingSoon: false,
      icon: Palette,
    },
    {
        ...
        <section className="container-wide mt-12 md:mt-16">
          <div className="border border-white/20 bg-white/5 backdrop-blur-sm rounded-sm p-6 md:p-8">
            ...
            <p className="text-white/75 mb-4 max-w-3xl">
              Move from concept to action by comparing services, reviewing completed projects, and preparing a <strong>clear renovation brief</strong>.
            </p>
