...
export const SITELINK_TARGETS: SitelinkTarget[] = [
  ...
  // New service pages
  {
    ...
    label: "Laundry Renovations",
    description: withBrandDescription("Gold Coast laundry renovations with custom cabinetry and smart storage."),
    includeInHeader: false,
    includeInFooter: true,
  },
  {
    path: "/outdoor-renovations-gold-coast",
    label: "Outdoor & Deck Renovations",
    description: withBrandDescription("Gold Coast outdoor renovations, decks, alfresco areas, and outdoor kitchens."),
    includeInHeader: false,
    includeInFooter: true,
  },
  {
    ...
    description: withBrandDescription("Gold Coast apartment renovations with body corporate compliance."),
    includeInHeader: false,
    includeInFooter: true,
  },
  {
    ...
    description: withBrandDescription("Gold Coast home extensions, second storey additions, and granny flats."),
    includeInHeader: false,
    includeInFooter: true,
  },
  // Location pages
  ...
  },
  {
    ...
    label: "Surfers Paradise Renovations",
    description: withBrandDescription("Apartment and home renovations in Surfers Paradise."),
    includeInFooter: false,
  },
  {
    path: "/bundall-renovations",
    label: "Bundall Renovations",
    description: withBrandDescription("Established home renovations in Bundall."),
    includeInFooter: false,
  },
  {
    path: "/runaway-bay-renovations",
    label: "Runaway Bay Renovations",
    description: withBrandDescription("Waterfront home renovations in Runaway Bay."),
    includeInFooter: false,
  },
  {
    path: "/coomera-renovations",
    label: "Coomera Renovations",
    description: withBrandDescription("Home renovations and upgrades in Coomera."),
    includeInFooter: false,
  },
  {
    path: "/upper-coomera-renovations",
    label: "Upper Coomera Renovations",
    description: withBrandDescription("Family home renovations in Upper Coomera."),
    includeInFooter: false,
  },
  {
    path: "/nerang-renovations",
    label: "Nerang Renovations",
    description: withBrandDescription("Hinterland home renovations in Nerang."),
    includeInFooter: false,
  },
  {
    path: "/mudgeeraba-renovations",
    label: "Mudgeeraba Renovations",
    description: withBrandDescription("Character and acreage home renovations in Mudgeeraba."),
    includeInFooter: false,
  },
  {
    path: "/varsity-lakes-renovations",
    label: "Varsity Lakes Renovations",
    description: withBrandDescription("Modern home renovations in Varsity Lakes."),
    includeInFooter: false,
  },
  {
    path: "/coolangatta-renovations",
    label: "Coolangatta Renovations",
    description: withBrandDescription("Coastal property renovations in Coolangatta."),
    includeInFooter: false,
  },
  {
    path: "/currumbin-renovations",
    label: "Currumbin Renovations",
    description: withBrandDescription("Beachside home renovations in Currumbin."),
    includeInFooter: false,
  },
  {
    path: "/miami-renovations",
    label: "Miami Renovations",
    description: withBrandDescription("Beach cottage and home renovations in Miami."),
    includeInFooter: false,
  },
  {
    path: "/hope-island-renovations",
    label: "Hope Island Renovations",
    description: withBrandDescription("Luxury waterfront renovations in Hope Island."),
    includeInFooter: false,
  },
  {
    path: "/sanctuary-cove-renovations",
    label: "Sanctuary Cove Renovations",
    description: withBrandDescription("Prestige home renovations in Sanctuary Cove."),
    includeInFooter: false,
  },
  {
    path: "/helensvale-renovations",
    label: "Helensvale Renovations",
    description: withBrandDescription("Family home renovations in Helensvale."),
    includeInFooter: false,
  },
];
